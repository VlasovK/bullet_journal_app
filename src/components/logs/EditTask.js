      ...
      <MDBContainer id="edit-task">
        <MDBCard className="mb-2">
          <MDBCardBody>
            ...
            />
            <div className={`status-line status-line-top mark-${
              this.state.task.mark}`}
            />
              ...
              <MDBDropdown dropup>
                ...
                <MDBDropdownMenu basic className="dropdown-left-30">
                  {this.props.logType !== 'futureLog' &&
                    <MDBDropdownItem
                      onClick={this.setTaskToMigrate('futureLog')}>
                      Future Log
                    </MDBDropdownItem>
                  }
                  <MDBDropdownItem
                    onClick={this.setTaskToMigrate('monthlyLog')}>
                    Monthly Log
                  </MDBDropdownItem>
            ...
            <MDBBtnGroup className="btn-group-width-100">
              <MDBBtn
                outline color="blue-grey" size="sm"
                disabled={!this.state.isTaskChanged
                  || !this.state.task.text.trim()}
                className="edit-task-btn"
                onClick={this.onSave}>
                save
              </MDBBtn>
